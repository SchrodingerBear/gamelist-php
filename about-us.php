...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <main class="main--area">
            ...
            <div class="row">
              ...
              >
                <div class="breadcrumb__img">
                  <img alt="img" src="./img/breadcrumb_img01.png" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-4">
              <div class="about__title-wrap">
                ...
                <div class="about__content-circle">
                  <img alt="img" src="./img/circle.svg" />
                  <svg
                    version="1.1"
                    viewbox="0 0 150 150"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-xl-8">
              <div class="about__three-images">
                <img alt="img" class="left" src="./img/mask_img01.jpg" />
                <img alt="img" class="right" src="./img/mask_img02.jpg" />
      ...
      <!-- services-area -->
      <section
        class="services-area services__bg-color section-pt-120 section-pb-120"
      >
        <div class="container">
