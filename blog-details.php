          ...
          <div class="blog-post-wrapper">
            <div class="blog-post-item">
              <div class="blog-post-thumb">
                <img alt="img" src="./img/blog_post03.jpg" />
              </div>
              <div class="blog-post-content blog-details-content">
                <div class="blog-post-meta">
                  <ul class="list-wrap">
                    ...
                    <li>
                      <i class="far fa-comments"></i><a href="#">No comments</a>
                    </li>
                  </ul>
                </div>
                ...
                <p>
                  ...
                  officia deserunt mollit anim id est labor umLor em ipsum
                  dolor amet, consteur adiscing Duis elentum solliciin is
                  yaugue euismods Nulla ullaorper. Ipsum is simply dummy text
                  of printing and typeetting industry. Lorem Ipsum has been
                  the industry's standsaard sipiscing Duis elementum
                  solliciin. Duis aute irure dolor in repderit in voluptate
                  velit esse cillum dolorliquip ex ea commodo repderit in
                  voluptate consequat nulla ullaorper.
                </p>
                <blockquote>
                  <p>
                    Duis elentum solliciin is yaugue euismods Nulla ullaorper.
                    Ipsum is simply dummy text of printing and typeetting
                    industry.
                  </p>
                </blockquote>
                <p>
                ...
                <p>
                  Simply dummy text of printing and typeetting industry. Lorem
                  Ipsum has been the industry's standsaard sipiscing Duis
                  elementum solliciin.Duis aute irure dolor in repderit.
                </p>
                <div class="blog-details-inner">
                  <h4 class="inner-title">nft games android no investment</h4>
                  <p>
                    Axcepteur sint occaecat atat non proident, sunt in culpa
                    qui officia deserunt mollit anim id est labor umLor em
                    ipsum dolor amet, consteur adiscing Duis elentum solliciin
                    is yaugue euismods Nulla ullaorper. Ipsum is simply dummy
                    text of printing and typeetting industry. Lorem Ipsum has
                    been the industry's standsaard sipiscing Duis elementum
                    solliciin.Duis aute irure dolor in repderit.
                  </p>
                </div>
                <div class="blog-details-inner-img">
                  <img alt="img" src="./img/blog_post02.jpg" />
                </div>
                <p>
                  Axcepteur sint occaecat atat non proident, sunt in culpa qui
                  officia deserunt mollit anim id est labor umLor em ipsum
                  dolor amet, consteur adiscing Duis elentum solliciin is
                  yaugue euismods Nulla ullaorper. Ipsum is simply dummy text
                  of printing and typeetting industry.
                </p>
            ...
            <div class="blog__avatar-wrap mb-65">
              <div class="blog__avatar-img">
                <a href="#"><img alt="img" src="./img/avatar.jpg" /></a>
              </div>
              <div class="blog__avatar-info">
                <span class="designation">Written by</span>
                <h4 class="name"><a href="#">Kaceytron G.</a></h4>
                <p>
                  Axcepteur sint occaecat atat non proident, sunt culpa
                  officia deserunt mollit anim id est labor umLor emdolor.
                </p>
              </div>
            </div>
              ...
              <div class="latest-comments">
                <ul class="list-wrap">
                  <li>
                    <div class="comments-box">
                      <div class="comments-avatar">
                        <img alt="img" src="./img/comment01.png" />
                      </div>
                    ...
                    <ul class="children">
                      <li>
                        <div class="comments-box">
                          <div class="comments-avatar">
                            <img alt="img" src="./img/comment02.png" />
                          </div>
                          <div class="comments-text">
                            <div class="avatar-name">
                              <h6 class="name">
                            ...
                            <p>
                              Axcepteur sint occaecat atat non proident, sunt
                              culpa officia deserunt mollit anim id est labor
                              enim ad minim veniam quis nostrud today.
                            </p>
                          </div>
                        </div>
                      </li>
                  ...
                  <li>
                    <div class="comments-box">
                      <div class="comments-avatar">
                        <img alt="img" src="./img/comment03.png" />
                      </div>
                      <div class="comments-text">
                        <div class="avatar-name">
                          <h6 class="name">
                        ...
                        <p>
                          Axcepteur sint occaecat atat non proident, sunt
                          culpa officia deserunt mollit anim id est labor
                          umLor emdolor eam enim ad minim veniam quis nostrud
                          today.
                        </p>
                      </div>
                    </div>
          ...
          <div class="blog-post-sidebar">
            <aside class="blog-sidebar">
              <div class="blog-widget">
                <div class="sidebar__author">
                  <div class="sidebar__author-thumb">
                    <img alt="img" src="./img/avatar.jpg" />
                  </div>
                  <div class="sidebar__author-content">
                    <h4 class="name">Kaceytron G.</h4>
                    <p>
                      Lorem ipsum sitamet conteur adipiscing Duis elementum
                      solliciin
                    </p>
              ...
              <div class="blog-widget widget_categories">
                ...
                <ul class="list-wrap">
                  <li>
                    <a href="#">gaming</a><span class="float-right">(11)</span>
                  </li>
                  <li>
                    <a href="#">ELECTRONIC</a><span class="float-right">(4)</span>
                  </li>
                  <li>
                    <a href="#">online</a><span class="float-right">(21)</span>
                  </li>
                  <li>
                    <a href="#">TOURNAMENT</a><span class="float-right">(15)</span>
                  </li>
                  <li>
                    <a href="#">controller</a><span class="float-right">(2)</span>
                  </li>
                  <li>
                    <a href="#">live</a><span class="float-right">(7)</span>
                  </li>
                </ul>
              </div>
              <div class="blog-widget">
                ...
                <div class="rc__post-wrapper">
                  <div class="rc__post-item">
                    <div class="rc__post-thumb">
                      <a href="blog-details.php"><img alt="img" src="./img/rc_post01.jpg" /></a>
                    </div>
                    <div class="rc__post-content">
                      <h6 class="title">
                        <a href="blog-details.php">zombie TOURNAMENT land max</a>
                      </h6>
                  ...
                  <div class="rc__post-item">
                    <div class="rc__post-thumb">
                      <a href="blog-details.php"><img alt="img" src="./img/rc_post02.jpg" /></a>
                    </div>
                    <div class="rc__post-content">
                      <h6 class="title">
                        <a href="blog-details.php">play to earn crypto games</a>
                      </h6>
                      <span class="date">aug 19, 2024</span>
                    </div>
                  </div>
                  <div class="rc__post-item">
                    <div class="rc__post-thumb">
                      <a href="blog-details.php"><img alt="img" src="./img/rc_post03.jpg" /></a>
                    </div>
                    <div class="rc__post-content">
                      <h6 class="title">
                        <a href="blog-details.php">nft games android land max</a>
                      </h6>
                      <span class="date">aug 19, 2024</span>
                    </div>
                  </div>
              ...
              <div class="blog-widget">
                ...
                <div class="sidebar__insta">
                  <div class="sidebar__insta-item">
                    <a href="https://www.instagram.com/" target="_blank"><img alt="img" src="./img/insta01.jpg" /></a>
                  </div>
                  <div class="sidebar__insta-item">
                    <a href="https://www.instagram.com/" target="_blank"><img alt="img" src="./img/insta02.jpg" /></a>
                  </div>
                  <div class="sidebar__insta-item">
                    <a href="https://www.instagram.com/" target="_blank"><img alt="img" src="./img/insta03.jpg" /></a>
                  </div>
                  <div class="sidebar__insta-item">
                    <a href="https://www.instagram.com/" target="_blank"><img alt="img" src="./img/insta04.jpg" /></a>
                  </div>
                  <div class="sidebar__insta-item">
                    <a href="https://www.instagram.com/" target="_blank"><img alt="img" src="./img/insta05.jpg" /></a>
                  </div>
                  <div class="sidebar__insta-item">
                    <a href="https://www.instagram.com/" target="_blank"><img alt="img" src="./img/insta06.jpg" /></a>
                  </div>
                </div>
              </div>
              <div class="blog-widget">
