...
<body>
  ...
  <main class="main--area">
    ...
    <!-- breadcrumb-area-end -->
    <!-- cart-area -->
    <div class="cart__area team-bg section-pt-120 section-pb-120" data-background="assets/img/bg/team_bg.jpg">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
              ...
              <tbody>
                <tr>
                  <td class="product__thumb">
                    <a href="shop-details.php"><img alt="" src="./img/product01.jpg" /></a>
                  </td>
                  <td class="product__name">
                    <a href="shop-details.php">Antiaging and Longevity</a>
                  </td>
                ...
                <tr>
                  <td class="product__thumb">
                    <a href="shop-details.php"><img alt="" src="./img/product02.jpg" /></a>
                  </td>
                  <td class="product__name">
                    <a href="shop-details.php">Time to Explore</a>
                  </td>
