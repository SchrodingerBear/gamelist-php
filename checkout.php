          ...
          <div class="col-lg-7">
            <form action="#" class="customer__form-wrap">
              ...
              <div class="form-grp select-grp">
                ...
                <select class="country-name" id="country-name" name="country-name">
              ...
              <div class="form-grp">
                ...
                <input id="street-address" placeholder="House number and street name" type="text" />
              </div>
              <div class="form-grp">
                <input id="street-address-two" placeholder="Apartment, suite, unit, etc. (optional)" type="text" />
              </div>
              <div class="form-grp">
                <label for="town-name">Town / City *</label>
                <input id="town-name" type="text" />
              </div>
              <div class="form-grp select-grp">
                <label for="district-name">District *</label>
                <select class="district-name" id="district-name" name="district-name">
