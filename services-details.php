          ...
          <div class="row">
            <div class="col-xl-6 col-lg-7">
              <div class="breadcrumb__content">
                <h2 class="title">Service Single</h2>
        ...
        <div class="row">
          <div class="col-12">
            <div class="team__details-img">
              <img alt="img" src="./img/services_details.jpg" />
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="team__details-inner-img">
                      <img alt="img" src="./img/services_details01.jpg" />
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="team__details-inner-img">
                      <img alt="img" src="./img/services_details02.jpg" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                      <button aria-controls="collapseOne" aria-expanded="true" class="accordion-button"
                        ...
                        <span class="count">1</span> Best NFT Game
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      <button aria-controls="collapseTwo" aria-expanded="false" class="accordion-button collapsed"
                        ...
                        <span class="count">2</span> Where can I get some?
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                      <button aria-controls="collapseThree" aria-expanded="false" class="accordion-button collapsed"
                        ...
                        <span class="count">3</span> Does it come from?
                      </button>
                    </h2>
