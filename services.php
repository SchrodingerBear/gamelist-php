                ...
                <div class="col-xl-5 col-lg-6">
                  <div class="roadMap__content">
                    ...
                    <p>
                      ...
                      sollicitudin is yaugue euismods Nulla ulla
                      Player-focused updates games from Mobile App and Enjoy.
                    </p>
                    <a class="tg-btn-1 -btn-yellow" href="contact.php">
                      <span>roadmap</span>
                      <svg fill="none" preserveaspectratio="none" viewbox="0 0 197 60"
                  ...
                  <div class="roadMap__img">
                    <img alt="" class="tg-parallax" data-orientation="down" data-scale="1.5" src="./img/roadmap.png" />
                  </div>
                </div>
                  ...
                  <div class="roadMap__steps-wrap">
                    <div class="roadMap__steps-item active">
                      ...
                      <ul class="roadMap__list list-wrap">
                        <li class="active tg__animate-text style2">
                      ...
                      <img alt="img" class="roadMap__steps-img" src="./img/roadmap_img.png" />
                    </div>
                    <div class="roadMap__steps-item">
                      ...
                      <ul class="roadMap__list list-wrap">
                        ...
                        <li class="tg__animate-text style2">
                          Land Creation &amp; Building
                        </li>
                      </ul>
                      <img alt="img" class="roadMap__steps-img" src="./img/roadmap_img.png" />
