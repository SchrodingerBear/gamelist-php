          ...
          <div class="blog-post-wrapper">
            <div class="tournament__details-content">
              ...
              <p>
                ...
                euismods Nulla ullaorper. Ipsum is simply dummy text of
                printing and typeetting industry. Lorem Ipsum has been the
                industry's standsaard sipiscing Duis elementum.
              </p>
              <div class="tournament__details-video position-relative">
                <img alt="img" src="./img/blog_post03.jpg" />
                <a class="popup-video" href="https://www.youtube.com/watch?v=_SAlU-hu8M0"><i
              ...
              <div class="tournament__details-form">
                <h4 class="tournament__details-form-title">
                  join nft games android
                </h4>
                <p>
                  Simply dummy text of printing and typeetting industry been
                  the industry's
                </p>
                <form action="#">
                  <input placeholder="Name *" type="text" />
                  <input placeholder="Player ID *" required="" type="text" />
                  <input placeholder="Email *" required="" type="email" />
                  <button class="tournament__details-form-btn">
                    Join Now
                  </button>
                </form>
              </div>
                  ...
                  <div class="trending__matches-list">
                    <div class="trending__matches-item">
                      <div class="trending__matches-thumb">
                        <a href="#"><img alt="img" src="./img/trend_match01.png" /></a>
                      </div>
                      <div class="trending__matches-content">
                        ...
                        <div class="play">
                          <a class="popup-video" href="https://www.youtube.com/watch?v=a3_o4SpV1vI"><i
                    ...
                    <div class="trending__matches-item">
                      <div class="trending__matches-thumb">
                        <a href="#"><img alt="img" src="./img/trend_match02.png" /></a>
                      </div>
                      <div class="trending__matches-content">
                        <div class="info">
                    ...
                    <div class="trending__matches-item">
                      <div class="trending__matches-thumb">
                        <a href="#"><img alt="img" src="./img/trend_match03.png" /></a>
                      </div>
                      <div class="trending__matches-content">
                        <div class="info">
              ...
              <div class="shop__widget">
                ...
                <div class="shop__widget-inner">
                  <div class="tournament__advertisement">
                    <a href="#"><img alt="img" src="./img/tournament_ad.jpg" /></a>
                  </div>
                </div>
              </div>
            </aside>
