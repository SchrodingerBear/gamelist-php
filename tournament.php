          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-5 position-relative d-none d-lg-block">
              <div class="breadcrumb__img">
                <img alt="img" src="./img/breadcrumb_img03.png" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row justify-content-center gutter-25">
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-9">
              <div class="tournament__box-wrap">
                <svg class="main-bg" fill="none" preserveaspectratio="none" viewbox="0 0 357 533" x="0px"
                  ...
                  <path clip-rule="evenodd"
                    ...
                    fill="#19222B" fill-rule="evenodd" stroke="#4C4C4C" stroke-width="0.25"></path>
                </svg>
                <svg class="price-bg" fill="none" preserveaspectratio="none" viewbox="0 0 166 56"
                ...
                <ul class="tournament__box-list list-wrap">
                  <li>
                    <div class="tournament__box-list-item">
                      <div class="tournament__player-thumb">
                        <img alt="img" src="./img/tournament01.jpg" />
                      </div>
                  ...
                  <li>
                    <div class="tournament__box-list-item">
                      <div class="tournament__player-thumb">
                        <img alt="img" src="./img/tournament02.jpg" />
                      </div>
                  ...
                  <li>
                    <div class="tournament__box-list-item">
                      <div class="tournament__player-thumb">
                        <img alt="img" src="./img/tournament03.jpg" />
                      </div>
            ...
            <div class="col-12">
              <div class="tournament__list-item-wrapper">
                <div class="tournament__list-item wow fadeInUp" data-wow-delay=".2s">
                  <svg height="163.37" viewbox="0 0 1116.562 163.37" width="1116.562"
                    xmlns="http://www.w3.org/2000/svg">
                    <path class="background-path"
                      ...
                      transform="translate(-401.563 -1749.875)"></path>
                  </svg>
                  <div class="tournament__list-content">
                    <div class="tournament__list-thumb">
                      <a href="tournament-details.php"><img alt="thumb" src="./img/tournament_thumb01.png" /></a>
                    </div>
                    ...
                    <div class="tournament__list-live">
                      <a href="https://www.twitch.tv/videos/1726788358" target="_blank">Live now <i
                ...
                <div class="tournament__list-item wow fadeInUp" data-wow-delay=".4s">
                  ...
                  <div class="tournament__list-content">
                    <div class="tournament__list-thumb">
                      <a href="tournament-details.php"><img alt="thumb" src="./img/tournament_thumb02.png" /></a>
                    </div>
                    <div class="tournament__list-name">
                ...
                <div class="tournament__list-item wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <div class="tournament__list-content">
                    <div class="tournament__list-thumb">
                      <a href="tournament-details.php"><img alt="thumb" src="./img/tournament_thumb03.png" /></a>
                    </div>
                    <div class="tournament__list-name">
